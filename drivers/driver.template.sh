...
#
# Full authoring guide: docs/content/docs/drivers.md in the Servo repo.
...
CAPABILITIES=
EOF
  # Declare only implemented optional verbs in CAPABILITIES (comma-separated).
...
start)
  ...
  # (systemd cleans up the whole service cgroup). See docs/content/docs/drivers.md.
