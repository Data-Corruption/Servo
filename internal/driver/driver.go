...
// HTTP) deals in Go types. See docs/ARCHITECTURE.md and docs/content/drivers.md.
package driver
...
// RunOutput separates machine-readable stdout from diagnostic stderr.
func RunOutput(ctx context.Context, env Env, stdout, stderr io.Writer, verb string, args ...string) (int, error) {
	return run(ctx, env, stdout, stderr, verb, args...)
}
